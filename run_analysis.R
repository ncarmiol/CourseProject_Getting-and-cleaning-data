...
setwd("~/Trabajo/Data science/Getting and cleaning data/quiz 4/Project/data")

#A full description is available at the site where the data was obtained: 
#http://archive.ics.uci.edu/ml/machine-learning-databases/00240/
#UCI%20HAR%20Dataset.names
...
#c.Unzip files in folder UCI HAR Dataset
path_rf <- file.path("./data" , "UCI HAR Dataset")
files<-list.files(path_rf, recursive=TRUE)
files

#SetWD
setwd("~/Trabajo/Data science/Getting and cleaning data/quiz 4/Project/data/UCI HAR Dataset")
files
...
# Merge the finalData set with the acitivity Type table to include 
